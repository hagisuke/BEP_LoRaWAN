...
<a id="anchor8"></a>
## 放流結果（放流日 2021年1月16日）
なぜかはんだ付けして作成した送信機は受信できなかったが、既存品の送信機は受信に成功した。データは[bbb.xlsx](/bbb.xlsx)を見てほしい。<br>
### ゲートウェイ設置点
...
### 受信成功点アニメーション
[![Animation](https://img.youtube.com/vi/YcSPV9prWr4&feature=youtu.be/0.jpg)](https://www.youtube.com/watch?v=YcSPV9prWr4&feature=youtu.be)
